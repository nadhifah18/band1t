<?php
include 'header.php';
$ambildata = $conn->query("SELECT * FROM users WHERE iduser='$_GET[id]'");
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="<?= $data['username'] ?>" class="form-control" name="nama" id="nama" required>
                                    </div>
                                </div>
...
if (isset($_POST['simpan'])) {
    ...
    $conn->query("UPDATE users SET username='$nama',email='$email',password='$password' WHERE iduser='$_GET[id]'") or die(mysqli_error($conn));
